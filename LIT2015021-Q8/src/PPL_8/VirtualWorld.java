...
public class VirtualWorld {
   ...
   /**
     ...
     * Gifting Algorithm is chosen according to entered choice
     * "1" method of class GiftSelectorOne is called
     * "2" method of class GiftSelectorTwo is called
     * "default" method of class GiftSelectorOne is called.
     * @param log a BufferedWriter
     * @throws IOException  if there is an error while reading/writing file
     */
        public void performGifting(BufferedWriter log,int ch) throws IOException{
            sortGiftsByPrice();
            GiftSelector ob1;
            if(ch!=2)
            ob1=new GiftSelectorOne();
            else
             ob1=new GiftSelectorTwo();
