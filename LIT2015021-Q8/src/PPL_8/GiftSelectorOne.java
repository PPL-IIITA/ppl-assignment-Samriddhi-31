...
/**
 *
 * Class that defines the first Gift Selection Algorithm( specified in problem statement).
 * Child class of class GiftSelector
 */
public class GiftSelectorOne extends GiftSelector {

    /**
     * Method that implements the first gifting algorithm specified in problem statement.
    ...
    public void selectGifts(Couple couple_ob[],Gift gift_ob[],BufferedWriter log) throws IOException{
        System.out.println("USING GIFTING ALGORITHM ONE");
        log.write(System.lineSeparator());
        log.write("USING GIFTING ALGORITHM ONE"+System.lineSeparator());
        log.write(System.lineSeparator());
