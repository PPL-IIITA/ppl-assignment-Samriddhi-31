 ...
 * Abstract Class that simulates and defines the attributes of Generalized Virtual World Boy.
   <br>Instance variables:<br>name: name of boy<br>attr: attractiveness<br>i_level: intelligence level:<br>budget: budget<br>min_attr: min attraction requirements
   <br>money_spent: amt spent on girlfriend<br>happiness: happiness<br>gf: name of girlfriend( if no girlfriend it will be set to null)
 *
 */
