...
public class VirtualWorld {
    ...
    /**
     * Method to allocate boyfriends to each girl according to her criteria: 0-"most rich" 1-"most intelligent" 2-"most attractive" according to problem statement using generic class RandomKSelector.
     *BetKSelector first returns best k valued items
     * RandomKSelector then returns a random item from those selected items.
     ...
     */
     public void makeMatches(BufferedWriter log, int k) throws IOException{
        ...
        while(itr.hasNext()){
            Boy  b=(Boy)itr.next();
            System.out.println(b.name+" "+b.gf);
        }*/
            Boy bx=null;
            RandomKSelector<Boy> ob2=new RandomKSelector<Boy>();
            bx=ob2.getRandomK(a,k);
            if(bx.gf!=null)
           ...
           // System.out.println(x+" "+i+m);
            ...
            m++;
                ...
                // ob1.getBestK(girl_ob, girl_attr, k);
                  Iterator itr=a.iterator();
       /* while(itr.hasNext()){
            Girl  o=(Girl)itr.next();
            System.out.println(o.name);
        }*/
        Girl gy=null;
                 RandomKSelector<Girl> ob2=new RandomKSelector<Girl>();
                gy=ob2.getRandomK(a,k);
    ...
    /**
     * Method that simulates gift exchanges between couples and logs them in text file "log.txt" according to problem statement using generic class RandomKSelector.
     *BetKSelector first returns best k valued items
     * RandomKSelector then returns a random item from those selected items.
     * @param log BufferedWriter object
     * @param k value of "k"
     ...
     */
        public void performGifting(BufferedWriter log,int k) throws IOException{
         ...
         //  gift_ob[i].gifted=false;
           ...
           RandomKSelector<Gift> ob2=new RandomKSelector<Gift>();
           Gift x=ob2.getRandomK(a,k);
        ...
        /**
         * Method to get the happiness and compatibility of each couple and print k happiest couples and k most compatible couples.
         * @param k value of "k"
         */
