   ...
   /** 
    ...
    public void displayMatches(){
        ...
        for(int i=0;i<couple_ob.length;i++){
            System.out.println(couple_ob[i].gf.name+" "+couple_ob[i].bf.name+System.lineSeparator()); //couple_ob[i].displayCouple();
        }
    }
     ...
     * Calls method defined in GiftSelectorOne Class.
     ...
     */
       ...
       /**
        * Method to perform break up of couples with happiness less than "t" at the end of every day for t days.
        * @param t value of "t"
        * @param log BufferedWriter object
        * @throws IOException 
        */
   public void performBreakUp(int t,BufferedWriter log) throws IOException{
             Date date=new Date();
             Stats s=new Stats();
       s.sortCouplesByHappiness(couple_ob);
        System.out.println();
       System.out.println("Performing breakup of couples with happiness < "+t);
        for(int i=0;i<couple_ob.length;i++){
            
            //System.out.println(couple_ob[i].happiness);
            if(couple_ob[i].happiness<t){
                System.out.println();
                 log.write(System.lineSeparator());
            ...
            for(int j=0;j<boy_ob.length;j++){
                if(boy_ob[j].min_attr<=couple_ob[i].gf.attr && boy_ob[j].budget>=couple_ob[i].gf.m_cost && boy_ob[j].gf==null){
                   ...
                   // System.out.println("money spent by "+couple_ob[i].bf.name+" = "+couple_ob[i].bf.money_spent);
                    log.write(System.lineSeparator());
